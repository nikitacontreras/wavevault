            ...
            <div className="mt-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                    {releases.map((release) => (
                        <div
                            key={release.id}
                            className={`group rounded-xl overflow-hidden transition-all ${isDark ? "bg-wv-surface border border-white/5 hover:border-white/20" : "bg-white border border-black/5 hover:border-black/20"}`}
                        >
                            {/* Cover Image */}
                            <div
                            ...
                            {/* Info */}
                            <div className="p-3">
                                <h4 className={`font-bold text-xs mb-1 truncate ${isDark ? "text-white" : "text-black"}`}>
                                    {release.title}
                                </h4>
